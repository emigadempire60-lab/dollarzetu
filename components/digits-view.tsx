...
import { TradingJournalCard } from '@/components/trading-journal-card';
      ...
      <div className="flex w-full max-w-7xl mx-auto flex-col px-3 py-2 sm:px-4 sm:py-4 gap-2 sm:gap-3 lg:flex-none lg:overflow-visible pb-10">
        {isLoading ? (
          ...
          <>
            ...
            <Card className="shrink-0 border shadow-sm mb-4">
                    ...
                    {tradeType !== 'even-odd' && (
                      <div className="py-4 sm:py-6 lg:py-0 lg:px-6 lg:border-l lg:border-border">
                        <DigitStatsBar
                          ...
                          onTickWindowChange={setTickWindow}
                        />
                      </div>
                    )}
            ...
            {/* Inline Positions Drawer */}
            {sellContract && openPositions.length > 0 && (
              <PositionsDrawer
            ...
            <TradingJournalCard className="mb-12" />
          </>
        )}
      </div>
