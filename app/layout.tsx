...
import { inter, jetbrainsMono, FONT_CLASS_MAP } from '@/lib/fonts';
  ...
  return (
    <html lang="en" className="h-full lg:h-auto dark" suppressHydrationWarning>
      <body
        ...
        className={`${fontClass} ${jetbrainsMono.variable} font-sans bg-background text-foreground flex min-h-dvh flex-col overflow-hidden max-lg:h-dvh max-lg:overflow-hidden lg:block lg:h-auto lg:min-h-screen lg:overflow-x-hidden lg:overflow-y-auto`}
      >
        <TemplateLayout>
